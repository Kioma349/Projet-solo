...
<Text style={{textAlignVertical: "center",textAlign: "center",}}> {"\n"}PAGE DE CONNEXION</Text>*/}
            ...
            <View style={style.title}>
                {/**title */}
                <Text style= {style.title_text}>FORMULAIRE D'INSCRIPTION </Text>
                ...
                <Text style= {style.text}>Pseudo:</Text>
                    <View style = { style.input_container}>
                            <TextInput secureTextEntry={false} placeholder='Entrer votre Pseudonyme'/>
                    </View>
                ...
                <View style= {style.input_group}>
                <Text style= {style.text}>Confirmation du Mot de passe :</Text>
                    <View style = { style.input_container}>
                            <TextInput  secureTextEntry={true} placeholder='Resaisir votre mot de passe '/>
                ...
                <View style={style.container}>
                    ...
                    <Text style={[style.text, style.button_text]}>S'INSCRIRE</Text>
                    </TouchableOpacity>
                    </View>
